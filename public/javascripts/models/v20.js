...
document.observe('dom:loaded', function() {
  ...
  $("dotPcm").observe('mouseover', function(event) {
  	featureRollover("/boatfeatures/engine/20v");
  }).observe('click', function(event) {
  	featureRollover("/boatfeatures/engine/20v");
  });
  
  $("dotStorage").observe('mouseover', function() {
  	featureRollover("/boatfeatures/sidestorage/20v");
  }).observe('click', function() {
  	featureRollover("/boatfeatures/sidestorage/20v");
  });
  
  $("dotFreeboard").observe('mouseover', function() {
  	featureRollover("/boatfeatures/freeboard/20v");
  }).observe('click', function() {
  	featureRollover("/boatfeatures/freeboard/20v");
  });
});
...
function Images() 
{
  var dir = "/public/images/models/";
	...
	this.images[0] = dir +"v20/main/1.jpg";
	this.images[1] = dir +"v20/main/2.jpg";
	this.images[2] = dir +"v20/main/3.jpg";
}
